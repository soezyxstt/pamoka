...
- **Status**: IN PROGRESS. Stage 7A, 7B, rehearsal Stage 7C, Stage 8A, Stage 8B, Stage 8C, Stage 8D, Stage 8E, Stage 8F, Stage 9A, dan Stage 9B selesai; pemetaan gelar masih menunggu source atau input operator. Tahap berikutnya adalah authoring peserta, kepengurusan, panitia, pengaturan edisi, aset situs, voting operasional, pustaka media, lalu domain admin yang belum memiliki read model. Upload media, editor WYSIWYG penuh, admin CMS penuh, handshake OAuth nyata, import operator, dan runtime publik belum menjadi target cutover.
