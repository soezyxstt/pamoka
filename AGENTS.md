...
- Plan 013 current checkpoint is Stage 10I. The next deployment gates are container build, Vercel preview, Aiven TLS, R2 handshake, authenticated browser QA, operator import, and public cutover; none of those external mutations are authorized by this change.
